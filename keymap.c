 ...
 * |  ^  |   &  |  [   |   ]  |  |   |     | . >  |   1  |   2  |   3  |   =  |
 * `------------+------+------+------|     |------+------+------+-------------'
 *              | Sett | ____ | ____ |     | ____ | Mouse | _0__ |
 *              `--------------------'     `--------------------'
 */
[Num_Sym] = LAYOUT_split_3x5_3(
  LCTL(KC_X), KC_EXLM,     KC_LPRN, KC_RPRN, KC_BSLS,        KC_KP_SLASH, KC_7,    KC_8,    KC_9,    KC_KP_MINUS,
  LCTL(KC_C), LCTL(KC_V),  KC_LCBR, KC_RCBR, KC_HASH,        KC_ASTR,     KC_4,    KC_5,    KC_6,    KC_KP_PLUS,
  KC_CIRC,    KC_AMPR,     KC_LBRC, KC_RBRC, KC_PIPE,        KC_DOT,      KC_1,    KC_2,    KC_3,    KC_EQUAL,
                      MO(Settings), _______, _______,        _______,     MO(Mouse), KC_0
),
 ...
 * Mouse
 * ,---------------------------------.     ,----------------------------------.
 * |  _  |   _  |   _  | whup |   _  |     |   _  | mwl  | mwr  |   _  |   _  |
 * |-----+------+------+------+------|     |------+------+------+------+------|
 * |  _  | left |  up  | right|   _  |     |   _  | lclk | rclk |   _  |   _  |
 * |-----+------+------+------+------|     |------+------+------+------+------|
 * |  _  |   _  | down | whdw |   _  |     |   _  | cmw  | bmw  | fmw  |   _  |
 * `------------+------+------+------|     |------+------+------+-------------'
 *              | ____ | ____ | ___  |     | ___  | ___  | ____ |
 *              `--------------------'     `--------------------'
 */
 [Mouse] = LAYOUT_split_3x5_3(
  _______,   _______,    _______,    KC_WH_U,    _______,        _______,    KC_WH_L,    KC_WH_R,    _______,    _______,
  _______,   KC_MS_L,    KC_MS_U,    KC_MS_R,    _______,        _______,    KC_BTN1,    KC_BTN2,    _______,    _______,
  _______,   _______,    KC_MS_D,    KC_WH_D,    _______,        _______,    KC_BTN3,    KC_BTN4,    KC_BTN5,    _______,
